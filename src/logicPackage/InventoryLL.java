...
public class InventoryLL {
    ...
    public static InventoryLL insert(InventoryLL list, int data) {
    ...
    public static InventoryLL deleteByKey(InventoryLL list, int key) {
        // Store head node
    ...
    public static void printList(InventoryLL list) {
